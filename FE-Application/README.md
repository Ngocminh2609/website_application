...
Ứng dụng Frontend cho Website bán hàng công nghệ cao cấp, được xây dựng trên nền tảng React và TypeScript với hiệu năng
vượt trội.

## ✨ Điểm Nổi Bật

- **Thiết kế Glassmorphism**: Sử dụng hiệu ứng kính mờ hiện đại, tạo cảm giác sang trọng và chuyên nghiệp.
- **TypeScript Enterprise Structure**: Cấu trúc phân lớp rõ ràng (api, types, components, pages) giúp dễ dàng bảo trì và
  mở rộng.
