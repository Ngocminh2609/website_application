...
export const notification = {
    ...
    success: (msg: string = UTILS_STRINGS.notification.successMsg) => {
        antdNotification.success({
            title: UTILS_STRINGS.notification.successTitle,
            description: msg,
            placement: "topRight",
            duration: 3,
        });
    ...
    error: (msg: string = UTILS_STRINGS.notification.errorMsg) => {
        antdNotification.error({
            title: UTILS_STRINGS.notification.errorTitle,
            description: msg,
            placement: "topRight",
            duration: 4,
        });
    ...
    info: (msg: string) => {
        antdNotification.info({
            title: UTILS_STRINGS.notification.infoTitle,
            description: msg,
            placement: "topRight",
            duration: 3,
        });
    ...
    warning: (msg: string) => {
        antdNotification.warning({
            title: UTILS_STRINGS.notification.warningTitle,
            description: msg,
            placement: "topRight",
            duration: 3,
        });
