        ...
        <section style={{ margin: '60px 0' }}>
            <div style={{ marginBottom: '32px' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '8px' }}>
                    <StarOutlined style={{ fontSize: '24px', color: 'var(--primary-color)' }} />
                    <Title level={2} style={{ margin: 0, fontSize: '2rem', fontWeight: 800 }}>
                        {title}
                    </Title>
                </div>
            ...
            <Row gutter={[24, 32]}>
                {personalized.map((product) => (
                    <Col xs={24} sm={12} md={8} lg={6} xl={4.8} key={product.id} className="grid-5-cols-col">
