 ...
 */
const RealTimeViewerCount: React.FC<RealTimeViewerCountProps> = ({ productId }) => {
    ...
    return (
        <div style={{
            ...
            <Space size={6}>
                <EyeOutlined className="animate-pulse-slow" style={{ color: '#ef4444', fontSize: '14px' }} />
                <Typography.Text style={{ color: '#ef4444', fontSize: '13px', fontWeight: 600 }}>
                    Hiện có <span style={{ fontSize: '15px', margin: '0 2px' }}>{displayCount}</span> người đang xem sản phẩm này
                </Typography.Text>
            </Space>
        </div>
    );
