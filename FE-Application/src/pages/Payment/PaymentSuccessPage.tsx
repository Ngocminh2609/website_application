  ...
  return (
    <div style={{ maxWidth: 800, margin: "0 auto", padding: "90px 20px 40px" }}>
      <Card
        ...
        bordered={false}
        style={{ boxShadow: "var(--card-shadow)", borderRadius: 16 }}
      >
        {status === "success" ? (
          <Result
            status="success"
            ...
            title={
              <Title level={2} style={{ color: "var(--text-main)" }}>
                ...
                >
                  <Space split={<Divider type="vertical" />} wrap>
                    <Text style={{ color: "var(--text-main)" }}>
                      Mã đơn hàng:{" "}
                      <b style={{ color: "var(--primary-color)" }}>#{txnRef}</b>
                    </Text>
                    <Text style={{ color: "var(--text-main)" }}>
                      Số tiền:{" "}
          ...
          <Result
            ...
            subTitle={
              <Text style={{ color: "var(--text-muted)" }}>
                Giao dịch của bạn đã bị hủy hoặc gặp lỗi trong quá trình xử lý.
          ...
          <div style={{ marginTop: 40, padding: "0 20px" }}>
            ...
            <Steps
              ...
              items={[
                ...
                {
                  title: (
                    <span style={{ color: "var(--text-main)" }}>Giao hàng</span>
                  ),
                  icon: <TruckOutlined />,
                },
                {
            ...
            >
              <Text italic style={{ color: "var(--text-muted)" }}>
                * Lưu ý: Đơn hàng sẽ bắt đầu được đóng gói và bàn giao cho đơn
                vị vận chuyển trong vòng 24h tới. Bạn có thể theo dõi trạng thái
                tại mục Đơn hàng của tôi.
              </Text>
            </div>
          </div>
        )}
