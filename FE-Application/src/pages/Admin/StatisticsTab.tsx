...
const PERIOD_OPTIONS = [
    {value: "daily", label: STATS_STRINGS.periods.daily},
    {value: "weekly", label: STATS_STRINGS.periods.weekly},
    {value: "monthly", label: STATS_STRINGS.periods.monthly},
    {value: "yearly", label: STATS_STRINGS.periods.yearly},
] as const;
