...
import { createDefaultProducts, DEFAULT_BANNERS } from "./helper";
...
const HomePage: React.FC = () => {
  ...
  const displayFlashSales =
    flashSales.length > 0 ? flashSales : createDefaultProducts("Flash Sale");
  const displayBestSellers =
    bestSellers.length > 0 ? bestSellers : createDefaultProducts("Bán Chạy", 5);
        ...
        <Spin
          ...
          tip={
            <Text style={{ color: "var(--text-main)" }}>
              Đang khởi tạo không gian mua sắm...
            </Text>
          }
        />
      </div>
  ...
  return (
    <div className="animate-fade-in" style={{ color: "var(--text-main)" }}>
        ...
        <div className="main-content">
          <Row gutter={[48, 48]} align="middle">
            <Col xs={24} lg={13}>
              ...
              >
                Chào mừng bạn đến với Tech Nova. Nơi cung cấp những thiết bị
                điện tử chính hãng, bảo hành chuẩn quốc tế và trải nghiệm mua
                sắm không giới hạn.
              </Paragraph>
              <Space size="large">
                <BaseButton
              ...
              <div style={{ marginTop: "60px", display: "flex", gap: "40px" }}>
                ...
                <Divider
                  type="vertical"
                  style={{ height: "40px", borderColor: "var(--glass-border)" }}
                />
                <div>
                  <Title
                    level={3}
      ...
      <div className="main-content">
        ...
        <PersonalizedRecommendations title="Gợi Ý Riêng Cho Bạn" limit={5} />
        ...
        >
          <div style={{ textAlign: "center", marginBottom: "60px" }}>
            ...
            >
              Những lựa chọn hàng đầu từ hàng triệu game thủ và người yêu công
              nghệ.
            </Text>
          </div>
          ...
          >
            {displayBestSellers.slice(0, 5).map((product) => (
              <div
                ...
                style={{ flex: "0 0 calc(20% - 26px)", minWidth: "220px" }}
              >
                <ProductCard product={product} />
              </div>
            ))}
        ...
        >
          <div style={{ position: "relative", zIndex: 2 }}>
            ...
            >
              Đừng bỏ lỡ những cập nhật công nghệ mới nhất. Trở thành thành viên
              của cộng đồng Tech Nova ngay hôm nay.
            </Text>
            <div
              style={{
                display: "flex",
