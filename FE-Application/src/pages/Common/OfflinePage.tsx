    ...
    return (
        <div style={{
            ...
            <Result
                ...
                title={<span style={{ color: 'var(--text-color, #fff)' }}>Mất kết nối internet</span>}
                subTitle={<span style={{ color: 'var(--text-color-secondary, #94a3b8)' }}>
                    Bạn đang ở chế độ ngoại tuyến. Một số tính năng có thể không khả dụng.
