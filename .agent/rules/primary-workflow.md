...
- For ambiguous workflow sequence, load `.claude/skills/fis-outcome/references/workflow-routing.md`.
...
- Explain the result plainly; use `/fis-preview` only for complex workflows or architecture. For visualization mode selection, load `.claude/skills/fis-preview/references/generation-modes.md`.
