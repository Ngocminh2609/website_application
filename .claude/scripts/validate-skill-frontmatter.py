...
# Exact name→category mappings for high-signal FIS AI Kit skills (avoids falling into "other")
EXACT_CATEGORY_MAP: dict[str, str] = {
    "ask": "utilities", "bootstrap": "utilities", "brainstorm": "utilities",
    "fis-autoresearch": "utilities", "fis-debug": "utilities", "fis-loop": "utilities",
    "fis-predict": "utilities", "fis-scenario": "utilities", "code-review": "utilities",
    "coding-level": "utilities", "context-engineering": "utilities", "craft": "utilities",
    "copywriting": "utilities", "debug": "utilities", "docs": "utilities",
    "fix": "utilities", "journal": "utilities", "markdown-novel-viewer": "utilities",
    "mermaidjs-v11": "utilities", "plan": "utilities", "fis-plan": "utilities",
    ...
    "worktree": "dev-tools", "fis-port-repo": "dev-tools", "fis-port-feature": "dev-tools",
    ...
    "fis-security": "utilities", "security-scan": "utilities",
}
